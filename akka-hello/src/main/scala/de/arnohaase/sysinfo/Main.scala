...
object Main extends App {
  ...
  val perc = ScalarType (name="Processor Load", unit="%", 2)
  val procLoad = ScalarValue (1234, perc)

  println (procLoad.userRepresentation)
  ...
  val infoProvider = system.actorOf(Props[InfoProviderActor] , "InfoProvider")
